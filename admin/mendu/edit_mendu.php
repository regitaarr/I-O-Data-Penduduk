<?php
    ...
    if(isset($_GET['kode'])){
		...
		tb_mendu m join tb_pdd p on m.nik=p.nik WHERE id_mendu='".$_GET['kode']."'";
...
<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Tanggal Meninggal Dunia</label>
				<div class="col-sm-3">
			...
			<div class="form-group row">
				...
				<select name="sebab" id="sebab" class="form-control">
						...
						<option>Penyakit atau Gangguan Medis</option>
						<option>Kecelakaan</option>
						<option>Penyakit Menular</option>
						<option>Komplikasi Kehamilan atau Persalinan</option>
						<option>Penyebab Lain</option>
				</select>
				</div>
			</div>
